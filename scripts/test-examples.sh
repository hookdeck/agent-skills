...
#   ./scripts/test-examples.sh event-gateway      # Test one specific skill
#
...
usage() {
  ...
  echo ""
  echo "Test agent skill example applications."
  echo ""
...
echo "========================================"
echo "  Agent Skills Example Tests"
echo "========================================"
echo ""
