...
**Manual replay:** Use the CLI TUI, web console, or Dashboard to replay individual events. Use the API for bulk replay — see [Bulk operations](https://hookdeck.com/docs/api/bulk) and [Inspect API](https://hookdeck.com/docs/api/inspect).
